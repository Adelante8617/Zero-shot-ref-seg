...
dataset = load_jsonl('output_v2prompt_test_A_api.jsonl')
...
for data in tqdm(dataset[:]):
    ...
    save_path = './Seg_Test_A_Api/'+str(data['segment_id'])+"_seg.png"
    img.save(save_path)
...
with open("output_seg_test_A_api_v2.jsonl", "a", encoding="utf-8") as f:
