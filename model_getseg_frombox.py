...
dataset = load_jsonl('output_test_B_v1_boxes.jsonl')
...
for data in tqdm(dataset[:]):
    ...
    save_path = './Seg_Test_B_v1/'+str(data['segment_id'])+"_seg.png"
    img.save(save_path)
...
with open("output_seg_test_B_v1.jsonl", "a", encoding="utf-8") as f:
